...
public class UserController : ControllerBase
{
    ...
    // GET: api/Jom
    [HttpGet]
    public async Task<ActionResult<IEnumerable<UserResponseDto>>> GetJoms()
    {
        var joms = await _context.Joms
            .Select(jom => new UserResponseDto
            {
                Id = jom.Id,
                Label = jom.Label,
                Date = jom.Date,
    ...
    // GET: api/Jom/"id"
    [HttpGet("{id}")]
    public async Task<ActionResult<UserResponseDto>> GetJom(int id)
    {
        ...
        var jomResponse = new UserResponseDto
        {
            Id = jom.Id,
            Label = jom.Label,
            Date = jom.Date,
    ...
    [HttpPost]
    public async Task<ActionResult<UserResponseDto>> PostJom(UserResponseDto jomRequest)
    {
        var jom = new Jom
        {
    ...
    // PUT: api/Jom/"id"
    [HttpPut("{id}")]
    public async Task<IActionResult> PutJom(int id, UserResponseDto jom)
    {
